...
if (not api):
    ...
    geocodes = ("34.0522342,-118.2436849,10km",
                "40.7127837,-74.0059413,10km",
                "41.8781136,-87.6297982,10km")

    for geocode in geocodes:
        print("Scraping data from geocode")
        cursor = tweepy.Cursor(api.search,q=("#trump"), count=20,
                            lang="en",
                            since="2019-09-23",until="2019-09-24",
                            geocode=geocode)
        results=[]
        for item in cur.items(20):
            results.append(item)
        print(results)
